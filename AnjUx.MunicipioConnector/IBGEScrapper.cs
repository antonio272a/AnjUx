...
namespace AnjUx.MunicipioConnector
{
    public class IBGEScraper
    {
        ...
        public async Task<Dictionary<int, Dictionary<string, MunicipioDado>>> BuscarEstimativarPopulacionais(int? anoInicial = null, int? anoFinal = null, string? codigoMunicipio = null)
        {
